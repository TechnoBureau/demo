...
#
# Technobureau NGINX library

# shellcheck disable=SC1090,SC1091

# Load Generic Libraries
. /opt/technobureau/scripts/libfs.sh
. /opt/technobureau/scripts/libfile.sh
. /opt/technobureau/scripts/liblog.sh
. /opt/technobureau/scripts/libos.sh
. /opt/technobureau/scripts/libservice.sh
. /opt/technobureau/scripts/libvalidations.sh
...
ensure_nginx_app_configuration_exists() {
    ...
    export document_root="${TECHNOBUREAU_ROOT_DIR}/${app}"
...
absolute_redirect off;"
    ...
    local template_dir="${TECHNOBUREAU_ROOT_DIR}/scripts/nginx/technobureau-templates"
...
absolute_redirect off;"
    ...
    local template_dir="${TECHNOBUREAU_ROOT_DIR}/scripts/nginx/technobureau-templates"
    local prefix_file="${NGINX_CONF_DIR}/technobureau/${app}.conf"
